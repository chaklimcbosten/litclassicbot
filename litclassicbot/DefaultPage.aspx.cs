...
namespace litclassicbot
{
    public partial class _Default : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            LabelAboutSite.Text = "<p>Человеку всегда необходимо прикасаться к ясному, " +
                "осознанному для него самого взгляду на жизнь. " +
                "Необходимо не только иметь его, но и постоянно укреплять, уточнять, " +
                "ища новые тонкости, уразумевая собственные заблуждения. " +
                "Не интернет виноват в том, что времяпровождение в нём не вносит в жизнь ей " +
                "необходимых, решительных качеств, двигающих к совершенству, но мы сами, " +
                "не сумевшие по-иному наполнить его и через это окружить себя и время своё таким наполнением.</p>" +
                "<p>Фантазия всегда к чему-либо прикасается. Неминуемо предметом её становится или добро или зло. " +
                "Первое лишь расправляет и направляет её к свету и свободе, второе - увлекает к рабским цепям. " +
                "Фантазия предполагается эволюцией как главная определяющая человека, " +
